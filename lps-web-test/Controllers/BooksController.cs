...
namespace lps_web_test.Controllers
{
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> ExportToCsv(string? searchString)
        {
            ...
            builder.AppendLine("Id,BookTitle,Author,BookTypeId,ReleaseDate,NumberOfPages");
            foreach (var b in list)
            {
                var line = $"{b.Id},\"{b.BookTitle}\",\"{b.Author}\",{b.BookTypeId},{b.ReleaseDate},{b.NumberOfPages}";
